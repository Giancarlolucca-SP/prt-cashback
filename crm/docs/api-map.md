...
- `POST /customers/:id/history-notes`
...
- `POST /leads/follow-ups/:id/appointment`
  - Converte follow-up pendente em agendamento formal, cria `Appointment`, conclui o follow-up e preserva auditoria cruzada.
- `GET/PATCH /leads/:id`
- `POST /leads/:id/stage`
