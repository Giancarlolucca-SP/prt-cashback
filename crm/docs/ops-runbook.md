...
- Variaveis de negocio de negociacao, comissao, impostos, prazos, limites e politicas comerciais devem ficar em configuracao/banco, com versionamento e auditoria. Rotas operacionais nao devem aceitar percentual, valor ou regra livre no payload quando a regra deveria vir de uma configuracao ativa.
