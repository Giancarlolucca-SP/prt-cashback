...
Para seeds repetidos de desenvolvimento/smoke, `SEED_REUSE_DEV_PASSWORD_HASH=true` reutiliza o hash ja salvo dos usuarios dev quando eles existem, evitando recalcular Argon2 sem alterar a senha.
