...
router.post('/redeem/request',        authenticateCustomer, validateDeviceId, ctrl.createRedemptionRequest);
router.get ('/redeem/request',        authenticateCustomer, validateDeviceId, ctrl.getRedemptionRequest);
router.post('/redeem/request/cancel', authenticateCustomer, validateDeviceId, ctrl.cancelRedemptionRequest);
