...
import {
  ChartLineUp, CurrencyDollar, Users, TrendDown, TrendUp, Warning,
...
export default function SaasDashboard() {
  ...
  if (authLoading || loading) {
    return (
      <div className="-mx-4 sm:-mx-6 -mt-6 bg-[#0f172a] min-h-screen flex items-center justify-center">
  ...
  // ── Render ─────────────────────────────────────────────────────────────────
  return (
    <div className="-mx-4 sm:-mx-6 -mt-6 bg-[#0f172a] min-h-screen px-4 sm:px-6 py-6 text-slate-100">

      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-white flex items-center gap-3">
          <ChartLineUp size={28} weight="duotone" className="text-amber-400" />
          PostoCash — Painel SaaS
        </h1>
        <p className="text-slate-400 text-sm mt-1">Métricas de receita e assinaturas em tempo real</p>
      </div>
      ...
      {/* Bottom row: CAC input + Establishments table */}
      <div className="grid grid-cols-1 xl:grid-cols-[280px_1fr] gap-6 mb-8">
        ...
        <div className="bg-[#1e293b] rounded-xl border border-slate-700 p-6 self-start">
          ...
          <p className="text-slate-500 text-xs mb-4">
            Informe o custo médio para adquirir um cliente (publicidade, vendas, etc.)
          </p>
