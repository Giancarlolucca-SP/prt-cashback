...
- S9-US07 revisada: logs obrigatorios aprovados para mensagens WhatsApp/e-mail, automacoes, alertas, OCR/leitura assistida, consultas externas em orgaos/TJ, perguntas/respostas da IA, sugestoes e bloqueios por permissao.
- Logs sao imutaveis; correcao ou observacao cria novo registro sem alterar o original.
- Gestor/Admin visualiza tudo; Administrativo ve logs operacionais/documentais conforme permissao; vendedor ve apenas logs dos proprios clientes/leads/vendas sem custos, DRE, NF financeira, documentos sensiveis ou prestadores financeiros; SDR ve proprios leads/agendamentos.
- Dados sensiveis devem ser mascarados ou bloqueados por permissao, incluindo CPF, documentos, anexos, financeiro, custos, margem, DRE, NF financeira e consultas externas.
- LGPD: registrar finalidade, origem, usuario/automacao, data/hora e processo vinculado para dados pessoais, OCR, aniversario, mensagens e consultas externas.
- Retencao de logs deve ser configuravel, sem exclusao curta para logs de auditoria sensiveis.
- Falhas de automacao, envio, OCR, consulta externa ou webhook geram log e, quando relevantes, alerta para Administrativo/Gestor.- S9-US06 revisada: sugestoes inteligentes aprovadas para leads/comercial, anuncios/estoque, oficina/prestadores, documentacao/venda e pos-venda.
...
## Proximo Passo
Revisar a Sprint 9 como um todo e consolidar o arquivo ready-for-dev.
