...
- S11-US03 criada para revisar: autenticacao propria, sessoes, RBAC, permissoes por modulo/acao/escopo/area sensivel, enforcement no backend, transferencia de responsabilidades e logs de acesso/permissao.
...
- S11-US02 criada para revisar: modelo de dados principal organizado por dominios, entidades do MVP, padroes globais, snapshots historicos, anexos em storage, jobs, IA/OCR, auditoria e decisoes pendentes sobre store_id, IDs, soft delete, vinculos polimorficos, snapshots e logs append-only.
...
## Proximo Passo
Revisar a S11-US03 e confirmar autenticacao, RBAC e escopos de permissao.
