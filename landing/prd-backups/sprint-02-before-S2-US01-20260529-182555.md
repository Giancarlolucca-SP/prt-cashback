...
**quero** visualizar e mover oportunidades em um Kanban comercial,  
**para** controlar cada atendimento desde o lead inicial ate a confirmacao de compra.
...
- Card com cliente/lead, veiculo de interesse, origem, responsavel, ultima interacao, proxima acao e idade do card.
- Drag and drop ou acao equivalente para mudar etapa.
- Filtros por responsavel, status, origem, veiculo, data e lead atrasado.
- Auditoria e historico em toda mudanca de etapa.

### Criterios Macro

- SDR ve e movimenta cards permitidos.
- Vendedor ve e movimenta cards da sua base/permissao.
- Gestor ve todos os cards.
- Mudanca de etapa registra historico e auditoria.
- Card em `Aguardando confirmacao de compra` fica pronto para S2-US04.
...
**Como** SDR ou Vendedor,  
**quero** criar agendamentos vinculados ao lead/cliente, veiculo e responsavel,  
**para** organizar visitas, test drives, retornos e compromissos comerciais.

### Escopo Inicial

- Tipos: visita na loja, test drive, retorno/follow-up, ligacao, atendimento presencial, entrega tecnica inicial.
- Status: agendado, confirmado, reagendado, compareceu, nao compareceu, cancelado, concluido.
- Data/hora, responsavel, local, observacao e veiculo relacionado quando houver.
- Agenda por vendedor/SDR.
- Visao administrativa consolidada de todos os vendedores.
- Registro de origem do agendamento.

### Criterios Macro

- Criar agendamento pelo Kanban ou detalhe do lead/cliente.
- Agendamento aparece na agenda do responsavel.
- Administrador/Gestor visualiza agenda consolidada.
...
**Como** Vendedor ou SDR,  
**quero** registrar interacoes e proximas acoes,  
**para** nao perder follow-ups e manter o historico comercial claro.

### Escopo Inicial

- Tipos de interacao: ligacao, WhatsApp manual, visita, test drive, proposta, observacao, retorno prometido, outro.
- Campo de resultado da interacao.
- Proxima acao com data/hora.
- Ultima interacao visivel no card.
- Follow-up atrasado destacado.
...
- Follow-up vencido fica destacado.
- Historico preserva usuario, data/hora, canal e observacao.

---

## S2-US04: Confirmacao de Compra e Passagem para Venda/Documentacao

**Como** Vendedor ou Administrativo,  
**quero** marcar uma oportunidade como compra confirmada,  
**para** abrir a passagem controlada para documentacao, pagamento e entrega tecnica.

### Escopo Inicial

- Acao de confirmar compra a partir do card em etapa avancada.
- Campos minimos: cliente, veiculo, vendedor, valor negociado, forma de pagamento prevista, observacao e data da confirmacao.
- Gerar status/registro de passagem para fluxo futuro de documentacao.
- Alerta interno de que documentacao e pagamento ainda precisam ser conferidos.
- Regra: confirmacao comercial nao significa liberar documento ou entrega.

### Criterios Macro

- Apenas usuario autorizado confirma compra.
- Confirmacao gera historico e auditoria.
- Card sai do fluxo comercial ativo ou muda para estado final configurado.
- Registro fica pronto para Kanban documental futuro.
...
- Metricas nao expõem dados financeiros sensiveis sem permissao.
