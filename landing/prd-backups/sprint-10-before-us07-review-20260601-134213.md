...
- S10-US07 criada para revisar: seguranca, auditoria imutavel, login/sessoes, bloqueio de usuario inativo, logs tecnicos, retencao/LGPD operacional, arquivos/documentos, backups e administracao tecnica.
...
- Alterar regra nao apaga historico; cada disparo mantem versao/regra usada.- S10-US05 revisada: categorias configuraveis aprovadas para origem do lead, status/motivo de perda, prestadores, servicos, financeiras, receitas adicionais, documentos, laudos/vistorias, despachante/servico documental e anuncios/campanhas.
...
- Toda criacao, edicao, inativacao e reativacao gera log.- S10-US04 revisada: configurar instancia principal `loja-principal` com numero oficial da loja via Evolution API.
...
- Toda alteracao, teste, reconexao, erro e troca de template gera log.- S10-US03 revisada: imposto sobre lucro padrao de 15%, configuravel pelo Dono/Gestor.
