...
- **FR-022J:** A base deve permitir cadastrar contatos de fornecedores de veiculos, repasses, concessionarias e donos/administradores de grupos de WhatsApp.
...
- **FR-054E:** O calculo de resultado da venda deve considerar receitas adicionais como retorno da financeira/financiamento, seguro, garantia, servicos e acessorios como lucro complementar, exibindo esses itens separadamente da margem principal do veiculo e tambem somados no lucro total da venda.
...
- **FR-083FA:** Cada processo de venda deve especificar os itens de lucro que compoem o resultado, incluindo margem do veiculo, retorno da financeira/financiamento, comissao de seguro, receita de garantia, servicos adicionais, acessorios e outros itens configuraveis.
...
- **FR-104Q:** Prestadores de servicos devem poder ser separados por categoria, com categorias iniciais como funilaria, mecanica, pintura, rodas, tapeceiro, vidros, vitrificacao, pintura de bancos, polimento, higienizacao, eletrica, pecas e outros servicos configuraveis.
...
- **FR-116A:** Dashboard e relatorios de venda devem exibir resultado adicional por financiamento, seguro e garantia, separando retorno da financeira/lucro de financiamento, comissao de seguro, receita/margem de garantia, outros itens de lucro e margem do veiculo, alem da soma total do lucro por venda.
...
## 12. Proximo Passo BMAD

1. Validar este PRD draft.
2. Definir MVP e fases.
3. Analisar em alto nivel os 10 epicos mapeados, documentando para cada epico: objetivo, escopo, fora de escopo, usuarios impactados, dependencias, riscos, integracoes, dados principais e valor de negocio.
...
9. Rodar `bmad-sprint-planning` para quebrar epicos conceituais em sprints, historias e tarefas tecnicas com checklists de aceite bem definidos para o desenvolvedor.
